...
export function values(options, name) { return options[name] ?? [] }
export function last(values) { return values?.[values.length - 1] }
export function scalar(options, name) { return last(options[name]) }
