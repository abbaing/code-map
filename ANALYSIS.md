...
| CS-03   | .NET API      | Supported        | String constants used by controller route attributes resolve.    |
...
- C# route constants resolve literal `const string` fields across the scanned backend; computed and non-string values remain unsupported.
