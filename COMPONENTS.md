...
Existing `gap` entries are the controlled remediation baseline for S12–S16. S17 will turn the target dependency rules into automated fitness functions, and S18 will require every remaining applicable status to be `pass`.
